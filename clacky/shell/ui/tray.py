...
class TrayManager(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self._tray.setToolTip(
            f"Clacky - AI Companion\nHold {cfg.hotkey} to speak"
        )
        self._search_enabled = True
        # CLACKY_WAKE_WORD=0 starts with the wake word off (e.g. demo recording,
        # where narration says "Clacky" while she's idle). Tray toggle still works.
        import os as _os
        self._wake_enabled = _os.environ.get("CLACKY_WAKE_WORD", "1") != "0"
    ...
    def _build_menu(self):
        ...
        wake_action = menu.addAction(
            "Wake word 'Clacky': ON" if self._wake_enabled else "Wake word 'Clacky': OFF"
        )
        ...
        wf_stop  = wf_menu.addAction("Stop + send to Clacky")
        ...
        quit_action = menu.addAction("Quit Clacky")
    ...
    def _toggle_wake(self, checked: bool):
        ...
        self._wake_action.setText(
            "Wake word 'Clacky': ON" if checked else "Wake word 'Clacky': OFF"
        )
