...
Action:   asks Clacky's manager to actually click the next pointed element
          instead of just hovering on it.

Copy this file to ~/.clacky/skills/ and edit, or write your own.
"""
...
SKILL = {
    ...
    "description": "Lets Clacky click the element it points at.",
