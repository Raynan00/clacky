...
Captures Clacky lessons as:
  • MP4 video — primary monitor, 8 fps, Clacky's pointer overlaid
  • Markdown transcript — Q&A + timestamps next to the video

Output:  ~/Documents/Clacky Lessons/<timestamp>/
...
class LessonRecorder:
    ...
    def start(self) -> Optional[Path]:
        ...
        self._out_dir = Path.home() / "Documents" / "Clacky Lessons" / ts
        ...
        self._md_lines = [f"# Clacky Lesson — {ts}", ""]
