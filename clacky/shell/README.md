...
| `CLACKY_HOTKEY` | `ctrl+alt+m` | Global push-to-talk combo |
| `CLACKY_STT` | *(auto)* | Force STT: `deepgram`/`openai`/`whisper_cpp`/`faster_whisper` |
| `CLACKY_ACTIVE_LLM` | *(auto)* | Force LLM: `claude`/`openai`/`copilot`/`gemini`/`ollama` |
